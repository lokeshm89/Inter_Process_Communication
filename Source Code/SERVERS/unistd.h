...
_PROTOTYPE( int printmessage, (void)   );
_PROTOTYPE( int ilir, (void)	);

/* ILIR IPC */
_PROTOTYPE( int   create, 	(char* group_name, int creator_pid)      	     );
_PROTOTYPE( int   subscribe,    (char* group_name, int sub_pid)         	     );
_PROTOTYPE( int   publish, 	(char* group_name, int publisher_pid, char* mesg)    );
_PROTOTYPE( char* retrieve,     (char* group_name, int sub_pid, int* ret)         	     );
_PROTOTYPE( int   delete_, 	(char* group_name, int creator_pid)         	     );
_PROTOTYPE( char* ListMembers,  (char* group_name, int pid, int* ret)         );
_PROTOTYPE( char* ListGroups, 	(int* ret)         					 );
