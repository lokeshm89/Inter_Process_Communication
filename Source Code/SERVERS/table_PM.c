...
_PROTOTYPE (int (*call_vec[]), (void) ) = {
	...
	do_group_create,		/* 113 = group_create */
	do_group_subscribe,		/* 114 = group_subscribe */
	do_group_publish,		/* 115 = group_publish*/
	do_group_retrieve,		/* 116 = group_retrieve */
	do_group_delete,		/* 117 = group_delete */
	do_list_members, 		/* 118 = list_members */
	do_list_groups,			/* 119 = list_messages */
};
