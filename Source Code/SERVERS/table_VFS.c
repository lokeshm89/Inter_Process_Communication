...
PUBLIC _PROTOTYPE (int (*call_vec[]), (void) ) = {
	...
	no_sys,		/* 113 = group_create */
	no_sys,		/* 114 = group_subscribe */
	no_sys,		/* 115 = group_publish*/
	no_sys,		/* 116 = group_retrieve */
	no_sys,		/* 117 = group_delete */
	no_sys, 	/* 118 = list_members */
	no_sys,		/* 119 = list_groups */
};
